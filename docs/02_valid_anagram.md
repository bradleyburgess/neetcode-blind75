...
> See [`solution.py`](../python/src/02_valid_anagram/solution.py) and 
[`test.py`](../python/src/02_valid_anagram/test.py)

### Java

> See [`ValidAnagram.java`](../java/src/main/java/arrays_hashing/ValidAnagram.java) and
[`ValidAnagramTest.java`](../java/src/test/java/arrays_hashing/ValidAnagramTest.java)